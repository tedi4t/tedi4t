...
| 🟩 Imperative programming      | 🟩 new                | 🟩 Mutable state     | 🟩 Observer              |
| 🟩 Structured programming      | 🟩 Static method      | 🟩 Immutable state   | 🟩 Decorator             |
| 🟩 Non-structured programming  | 🟩 Method             | 🟩 Enum              | 🟩 Fabric                |
| 🟩 Functional programming      | 🟩 Async method       | 🟩 Linked list       | 🟩 Command               |
